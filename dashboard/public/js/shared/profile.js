(function () {
  if (window.__trkSharedProfileInitialised) return;
  window.__trkSharedProfileInitialised = true;
  ...
  function getProfileConfig() {
    ...
    return {
      role: page.getAttribute("data-profile-role") || "",
      formId: page.getAttribute("data-profile-form-id") || "profileForm",
      messageId: page.getAttribute("data-profile-message-id") || "profileMessage"
    };
  }
