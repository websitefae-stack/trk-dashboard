...
def _serialize_invoice(doc):
    ...
    return {
        ...
        "paid_amount": payment_utils.get_display_paid_amount(doc.grand_total, doc.outstanding_amount),
...
def allocate_invoice_payment(invoice_name=None, posting_date=None, amount=None, bank_account=None, reference_no=None):
    ...
    return {
        ...
        "paid_amount": payment_utils.get_display_paid_amount(invoice.grand_total, invoice.outstanding_amount),
